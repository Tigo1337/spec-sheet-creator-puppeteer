...
interface CanvasState {
  ...
  aiFieldNames: Set<string>; // NEW: Tracks columns generated by AI
  ...
  markAiField: (header: string) => void; // NEW Action
...
export const useCanvasStore = create<CanvasState>((set, get) => ({
  ...
  aiFieldNames: new Set(), // NEW Initial State
  ...
  setExcelData: (data) => set({ 
    ...
    selectedRowIndex: 0, 
    imageFieldNames: new Set(),
    aiFieldNames: new Set() // Clear AI fields on new import
  }),
  ...
  markAiField: (header) => // NEW IMPLEMENTATION
    set((state) => {
